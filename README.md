...
Se aceptan reportes de errores y solicitudes de cambio (*pull requests*). Por favor, abra primero un *issue* para discutir las modificaciones propuestas antes de enviar un *pull request*. Al adaptar el marco a nuevas estaciones o extender la metodología, se solicita referenciar el preprint original en su trabajo.
