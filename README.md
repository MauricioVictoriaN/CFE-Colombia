...
[![DOI](https://img.shields.io/badge/DOI-10.31224%2F7129-orange.svg)](https://doi.org/10.31224/7129)
...
Si utiliza este marco en su investigación, por favor cite el manuscrito publicado:

> Victoria, M. (2026). *Non-stationary flood frequency analysis in the Guachicono River (Colombian Andes): trend detection, GAMLSS modeling and design quantiles*. EngrXiv. https://doi.org/10.31224/7129

**BibTeX:**

```bibtex
@techreport{victoria2026cfe,
  author       = {Victoria, Mauricio},
  title        = {Non-stationary flood frequency analysis in the {Guachicono River}
                  ({Colombian Andes}): trend detection, {GAMLSS} modeling and
                  design quantiles},
  institution  = {EngrXiv},
  year         = {2026},
  doi          = {10.31224/7129},
  url          = {https://doi.org/10.31224/7129}
}
```
